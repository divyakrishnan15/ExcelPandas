...
"OFFENSE_DESCRIPTION":str,"DISTRICT":str,"REPORTING_AREA":str, "SHOOTING":str, "YEAR":str, "MONTH":str, "DAY_OF_WEEK":str, "HOUR":str})
...
row1=dataframe_to_rows(df2)
for r_idx, row in enumerate(row1,8):
    for c_idx,value in enumerate(row,1):
        #print(col)
        ws.cell(row=r_idx,column=c_idx,value=value)

wb.save('crime_report_output.xlsx')
